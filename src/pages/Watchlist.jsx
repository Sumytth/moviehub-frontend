  ...
  return (
    <div className="w-full min-h-screen pt-24 px-4 md:px-12 text-white">
      ...
      {watchlist.length === 0 ? (
        ...
        // <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5 gap-4 overflow-hidden">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 justify-items-center overflow-hidden">
          {watchlist.map((movie) => (
